...
from verl.models.deepseekv2.megatron.layers.parallel_linear import MergedColumnParallelLinear

from verl.utils.megatron import tensor_parallel as tp_utils
from verl.utils.megatron_utils import convert_deepseekv2_config


class ParallelDeepseekV2MLP(nn.Module):

    def __init__(self, config, megatron_config: ModelParallelConfig = None, intermediate_size=None) -> None:
        super().__init__()
        self.config = config
